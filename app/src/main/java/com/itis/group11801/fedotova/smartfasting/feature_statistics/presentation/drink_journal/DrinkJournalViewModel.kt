...
class DrinkJournalViewModel @Inject constructor(
    ...
    private val journal: LiveData<List<DrinkNote>> = interactor.getDrinkNotes()

    val drinkNotes: LiveData<List<JournalParent>> =
        Transformations.switchMap(journal, ::convertData)
